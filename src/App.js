...
import DNAtext from './components/DNAtext';
import './App.css';
    ...
    return (
      <div className="App">
        <header className="App-header">
           ...
           <svg
              ...
              <g
                ...
                <g
                  ...
                  <path
                    id="path53690"
                    style={{ fill:'#cccccc',fillOpacity:1,fillRule:'nonzero',stroke:'none' }}
           ...
           <a className="navbar-brand" id="devnetLogo" href="devnet">DEVNET</a>
           <ul className="navbar-nav mr-auto" id="navList">
             ...
             <li className="nav-item">
               <a className="nav-link disabled" href="support">Support</a>
             </li>
           </ul>
          ...
          <div className="logSearch"><span className="login">Log In | Register</span><br /><br />
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="18">
              <g strokeWidth="2" stroke="#cccccc" fill="none">
        ...
        <footer>
          Transformable Networking has arrived
        </footer>
      </div>
    );
  }
